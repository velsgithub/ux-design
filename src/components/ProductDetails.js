...
const LabelSection = props => <div>
    ...
    <h4 className='m-0'>{props.value}</h4>
</div>
    ...
    return <>
        ...
        <div className='p-grid' style={{ alignItems: 'center' }}>
            ...
            <div className="p-col-7 p-0 pl-min">
                ...
                <h4 className='m-0 mb-min'>Full Spec</h4>
        ...
        <div className='mt-1'>
            <h4 className='m-0'>Battery({product.batteryType})</h4>
            <ProgressBar showValue={false} value={75} />
        </div>
